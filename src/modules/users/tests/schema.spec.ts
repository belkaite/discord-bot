...
//     const userWithEmptyLastName = { ...fakeUser(), first_name: '' }
//     const userWithNoLastName = omit(fakeUser(), ['first_name'])

//     expect(() => parse(userWithEmptyLastName)).toThrow(/first_name/i)
//     expect(() => parse(userWithNoLastName)).toThrow(/first_name/i)
//   })
